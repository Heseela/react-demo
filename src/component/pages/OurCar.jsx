...
function OurCar() {
  ...
  const array=[
    ...
    {label:'Contact',name:'Contact',type:"text",placeholder:'Enter your contact number'},
  ...
  return (
    <div className="h-full w-4/12 lg:w-6/12 shadow-md my-10 py-7  mx-auto bg-gray-900">
      ...
      <ReactQuill theme="snow" className="bg-white w-10/12 mx-auto "  value={value} onChange={setValue} />;
